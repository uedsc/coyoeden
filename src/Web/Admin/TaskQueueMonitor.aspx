<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="TaskQueueMonitor.aspx.cs" Inherits="Cynthia.Web.AdminUI.TaskQueueMonitorPage" %>
...
<div class="settingrow">
	...
	<portal:CButton ID="btnTest" runat="server" Visible="false" />
	<portal:CButton ID="btnStartTasks" runat="server" Visible="false" />
</div>
<div class="settingrow">
<cy:SiteLabel id="SiteLabel2" runat="server" CssClass="settinglabel" ConfigKey="TaskQueueAvailableThreadsLabel"> </cy:SiteLabel>
