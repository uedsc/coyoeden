...
namespace Cynthia.Web.UI
{
    ...
    public class DisqusWidget : WebControl
    {
        ...
        private void RenderThreadWidget(HtmlTextWriter writer)
        {
            ...
            //writer.Write("<script type=\"text/javascript\" src=\"http://disqus.com/forums/" + siteShortName + "/embed.js\" ></script>");
        ...
        private void SetupWidgetVars()
        {
            ...
            Page.ClientScript.RegisterStartupScript(typeof(Page), "disqusmain", "<script type=\"text/javascript\" src=\"http://disqus.com/forums/" + siteShortName + "/embed.js\" ></script>", false);
        }
