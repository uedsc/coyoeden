...
namespace WebStore.UI
{
    ...
    public partial class AdminOrderCheckoutPage : CBasePage
    {
        ...
        private void PopulateLabels()
        {
            ...
            if (c != null)
            {
                ...
                crumbs.AddedCrumbs
                    ...
                    + "</a>"
                    + "&nbsp;&gt;&nbsp;<a href='"
                    + SiteRoot + "/WebStore/AdminOrderEntry.aspx?pageid=" + pageId.ToString() + "&amp;mid=" + moduleId.ToString()
            ...
            litHeading.Text = WebStoreResources.OrderEntryCheckoutHeader;
