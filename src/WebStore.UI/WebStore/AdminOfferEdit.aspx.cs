...
{
    public partial class AdminOfferEditPage : CBasePage
    {
        ...
        private void PopulateOfferControls()
        {
            ...
            if (offerGuid != Guid.Empty)
            {
                ...
                txtSortRank1.Text = offer.SortRank1.ToString(CultureInfo.InvariantCulture);
                txtSortRank2.Text = offer.SortRank2.ToString(CultureInfo.InvariantCulture);
        ...
        private void Save()
        {
            ...
            {
                offer.Url = "/"
                    + FriendlyUrl.SuggestFriendlyUrl(
        ...
        private void PopulateLabels()
        {
            ...
            if (c != null)
            {
                ...
                crumbs.AddedCrumbs = "<a href='"
                    ...
                    + "</a>&nbsp;&gt;&nbsp;<a href='"
                    + SiteRoot + "/WebStore/AdminOffer.aspx?pageid=" + pageId.ToString(CultureInfo.InvariantCulture) + "&amp;mid=" + moduleId.ToString(CultureInfo.InvariantCulture)
        ...
        protected String GetBeginDate(Object o)
        {
            ...
            {
                return DateTime.Now.AddHours(-timeOffset).ToString();

            }
            if (o is DateTime)
            {
                return ((DateTime)o).AddHours(-timeOffset).ToString();
            }
