...
namespace WebStore.UI
{
    ...
    public partial class ConfirmOrderPage : CBasePage
    {
        ...
        private void PopulateLabels()
        {
            ...
            litConfirmOrder.Text = WebStoreResources.ConfirmOrderHeading;
        ...
        private void LoadSettings()
        {
            ...
            if ((canCheckoutWithoutAuthentication)||(Request.IsAuthenticated))
            {
                ...
                pnlOrderDetail.Visible = commerceConfig.CanProcessStandardCards;
