...
namespace PollFeature.Data
{
    public static class DBPollOption
    {
        ...
        /// <summary>
        /// Inserts a row in the cy_PollOptions table. Returns rows affected count.
        /// </summary>
            ...
            int order)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_PollOptions (");
        ...
        /// <summary>
        /// Updates a row in the cy_PollOptions table. Returns true if row updated.
        /// </summary>
        /// <param name="optionGuid"> optionGuid </param>
        /// <param name="pollGuid"> pollGuid </param>
        /// <param name="answer"> answer </param>
            ...
            int order)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_PollOptions ");
        ...
        /// <summary>
        /// Deletes a row from the cy_PollOptions table. Returns true if row deleted.
        /// </summary>
        /// <param name="optionGuid"> optionGuid </param>
        /// <returns>bool</returns>
        ...
        /// <summary>
        /// Gets an IDataReader from the cy_PollOptions table.
        /// </summary>
        ...
        public static IDataReader GetPollOptions(Guid pollGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_PollOptions ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PollGuid = ?PollGuid ");
            sqlCommand.Append("ORDER BY Answer ");
            sqlCommand.Append(";");
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_PollOptions table.
        /// </summary>
        /// <param name="optionGuid"> optionGuid </param>
            ...
            Guid userGuid)
        {
            ...
            {
                sqlCommand.Append("INSERT INTO cy_PollUsers (");
                sqlCommand.Append("PollGuid, ");
                sqlCommand.Append("OptionGuid, ");
