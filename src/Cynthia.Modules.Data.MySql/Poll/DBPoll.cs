...
namespace PollFeature.Data
{
    public static class DBPoll
    {
        ...
        /// <summary>
        /// Inserts a row in the cy_Polls table. Returns rows affected count.
        /// </summary>
            ...
            DateTime activeTo)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_Polls (");
        ...
        /// <summary>
        /// Updates a row in the cy_Polls table. Returns true if row updated.
        /// </summary>
        /// <param name="pollGuid"> pollGuid </param>
        /// <param name="question"> question </param>
        /// <param name="active"> active </param>
            ...
            DateTime activeTo)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_Polls ");
        ...
        /// <summary>
        /// Deletes a row from the cy_Polls table. Returns true if row deleted.
        /// </summary>
        /// <param name="pollGuid"> pollGuid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid pollGuid)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_PollModules ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PollGuid = ?PollGuid ");
            sqlCommand.Append(";");

            sqlCommand.Append("DELETE FROM cy_PollUsers ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PollGuid = ?PollGuid ");
            sqlCommand.Append(";");

            sqlCommand.Append("DELETE FROM cy_PollOptions ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PollGuid = ?PollGuid ");
            sqlCommand.Append(";");

            sqlCommand.Append("DELETE FROM cy_Polls ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PollGuid = ?PollGuid ");
            sqlCommand.Append(";");
        ...
        public static bool DeleteBySite(int siteId)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_PollModules ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID) ");
            sqlCommand.Append(";");

            sqlCommand.Append("DELETE FROM cy_PollUsers ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PollGuid IN (SELECT PollGuid FROM cy_Polls WHERE SiteGuid IN (SELECT SiteGuid FROM cy_Sites WHERE SiteID = ?SiteID)) ");
            sqlCommand.Append(";");
        ...
        /// <summary>
        /// Clears the vote count a row from the cy_Polls table. 
        /// </summary>
        /// <param name="pollGuid"> pollGuid </param>
        /// <returns>bool</returns>
        public static bool ClearVotes(Guid pollGuid)
        {
            ...
            sqlCommand.Append("UPDATE cy_PollUsers ");
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_Polls table.
        /// </summary>
        /// <param name="pollGuid"> pollGuid </param>
        public static IDataReader GetPoll(Guid pollGuid)
        {
            ...
            sqlCommand.Append("(SELECT SUM(Votes) FROM cy_PollOptions WHERE cy_PollOptions.PollGuid = ?PollGuid) As TotalVotes ");

            sqlCommand.Append("FROM	cy_Polls p ");
            sqlCommand.Append("WHERE ");
        ...
        public static IDataReader GetPollByModuleID(int moduleId)
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("SELECT  p.*, ");
            sqlCommand.Append("(SELECT SUM(po.Votes) FROM cy_PollOptions po WHERE po.PollGuid = p.PollGuid) As TotalVotes ");

            sqlCommand.Append("FROM	cy_Polls p ");

            sqlCommand.Append("JOIN cy_PollModules pm ");
        ...
        /// <summary>
        /// Gets an IDataReader with all rows from the cy_Polls table matching the siteGuid.
        /// </summary>
        /// <param name="siteGuid"> siteGuid </param>
        public static IDataReader GetPolls(Guid siteGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_Polls ");
            sqlCommand.Append("WHERE ");
        ...
        public static IDataReader GetPollsByUserGuid(Guid userGuid)
        {
            ...
            sqlCommand.Append("JOIN cy_PollUsers pu ");
            sqlCommand.Append("ON p.PollGuid = pu.PollGuid ");

            sqlCommand.Append("JOIN cy_PollOptions po ");
        ...
        /// <summary>
        /// Gets a count of rows in the cy_Polls table.
        /// </summary>
        public static bool UserHasVoted(Guid pollGuid, Guid userGuid)
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("SELECT  Count(*) ");
            sqlCommand.Append("FROM	cy_PollUsers ");
            sqlCommand.Append("WHERE ");
        ...
        public static bool AddToModule(Guid pollGuid, int moduleId)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_PollModules (PollGuid, ModuleID) ");
            sqlCommand.Append("VALUES( ");
