...
namespace Cynthia.Data
{
    public static class DBRssFeed
    {
            ...
            int sortRank)
        {
            ...
            arParams[3] = new MySqlParameter("?Url", MySqlDbType.VarChar, 255);
            ...
            int sortRank)
        {
            ...
            sqlCommand.Append("UPDATE cy_RssFeeds ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_RssFeeds ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ItemID = ?ItemID ;");
        ...
        public static bool DeleteByModule(int moduleId)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_RssFeedEntries ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("FeedID IN (SELECT ItemID FROM cy_RssFeeds WHERE ModuleID  = ?ModuleID);");
        ...
        public static bool DeleteBySite(int siteId)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_RssFeedEntries ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("FeedID IN (SELECT ItemID FROM cy_RssFeeds WHERE ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID));");
        ...
        public static IDataReader GetRssFeed(int itemId)
        {
            ...
            sqlCommand.Append("FROM	cy_RssFeeds ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ItemID = ?ItemID ;");
        ...
        public static IDataReader GetFeeds(int moduleId)
        {
            ...
            sqlCommand.Append(" (SELECT COUNT(*) FROM cy_RssFeedEntries e WHERE e.FeedId = f.ItemID) As TotalEntries ");

            sqlCommand.Append("FROM	cy_RssFeeds f ");
            sqlCommand.Append("WHERE ");
        ...
        public static IDataReader GetEntries(Guid moduleGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_RssFeedEntries e ");
            sqlCommand.Append("JOIN ");
            sqlCommand.Append("cy_RssFeeds f ");
        ...
        public static bool EntryExists(Guid moduleGuid, int entryHash)
        {
            ...
            sqlCommand.Append("FROM	cy_RssFeedEntries ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ModuleGuid = ?ModuleGuid ");
            ...
            DateTime cachedTimeUtc)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_RssFeedEntries (");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_RssFeedEntries ");
            sqlCommand.Append("SET  ");
