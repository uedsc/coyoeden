...
namespace Cynthia.Data
{
    public static class DBLinks
    {
            ...
            Guid userGuid)
        {
            ...
            arParams[2] = new MySqlParameter("?Url", MySqlDbType.VarChar, 255);
            ...
            int createdBy)
        {
            ...
            sqlCommand.Append("UPDATE cy_Links ");
            ...
            arParams[5] = new MySqlParameter("?Description", MySqlDbType.Text);
            arParams[5].Direction = ParameterDirection.Input;
        ...
        public static IDataReader GetLinksByPage(int siteId, int pageId)
        {
            ...
            sqlCommand.Append("FROM	cy_Links ce ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_Links ");
            sqlCommand.Append("WHERE ItemID = ?ItemID ;");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_Links WHERE ModuleID = ?ModuleID;");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_Links WHERE ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID);");
