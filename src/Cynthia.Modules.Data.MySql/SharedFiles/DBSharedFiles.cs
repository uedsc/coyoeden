...
namespace Cynthia.Data
{
    public static class DBSharedFiles
    {
            ...
            int parentId)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_SharedFileFolders (");
            ...
            Guid parentGuid)
        {
            ...
            sqlCommand.Append("UPDATE cy_SharedFileFolders ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_SharedFileFolders ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("FolderID = ?FolderID ;");
        ...
        public static IDataReader GetSharedFileFolder(int folderId)
        {
            ...
            sqlCommand.Append("FROM	cy_SharedFileFolders ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("FolderID = ?FolderID ;");
        ...
        public static IDataReader GetSharedModuleFolders(int moduleId)
        {
            ...
            sqlCommand.Append("FROM	cy_SharedFileFolders sff ");
            sqlCommand.Append("WHERE ");
            ...
            string description)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_SharedFiles (");
            sqlCommand.Append("ModuleID, ");
            ...
            string description)
        {
            ...
            arParams[11] = new MySqlParameter("?Description", MySqlDbType.Text);
            arParams[11].Direction = ParameterDirection.Input;
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_SharedFiles ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ItemID = ?ItemID ;");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_SharedFilesHistory WHERE ModuleID = ?ModuleID;");
            sqlCommand.Append("DELETE FROM cy_SharedFiles WHERE ModuleID = ?ModuleID;");
            sqlCommand.Append("DELETE FROM cy_SharedFileFolders WHERE ModuleID = ?ModuleID;");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_SharedFilesHistory WHERE ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID);");
            sqlCommand.Append("DELETE FROM cy_SharedFiles WHERE ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID);");
            sqlCommand.Append("DELETE FROM cy_SharedFileFolders WHERE ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID);");
        ...
        public static IDataReader GetSharedFile(int itemId)
        {
            ...
            sqlCommand.Append("FROM	cy_SharedFiles ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ItemID = ?ItemID ;");
        ...
        public static IDataReader GetSharedFilesByPage(int siteId, int pageId)
        {
            ...
            sqlCommand.Append("FROM	cy_SharedFiles ce ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_SharedFilesHistory ");
            sqlCommand.Append("WHERE ");
