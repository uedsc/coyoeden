...
namespace SurveyFeature.Data
{
    ...
    public static class DBSurvey
    {
            ...
            string endPageText)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_Surveys (");
            ...
            string endPageText)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_Surveys ");
        ...
        public static void Delete(Guid surveyGuid)
        {
            ...
            sqlCommand.Append("FROM cy_SurveyQuestions ");
            sqlCommand.Append("WHERE ");
            ...
            sqlCommand.Append("DELETE FROM cy_SurveyQuestions ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("PageGuid IN (");
            sqlCommand.Append("SELECT PageGuid ");
            sqlCommand.Append("FROM cy_SurveyPages ");
            ...
            sqlCommand.Append("DELETE FROM cy_SurveyPages ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SurveyGuid = ?SurveyGuid; ");

            //now delete survey
            sqlCommand.Append("DELETE FROM cy_Surveys ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SurveyGuid = ?SurveyGuid;");
        ...
        public static bool DeleteBySite(int siteId)
        {
            ...
            sqlCommand.Append("FROM cy_SurveyPages ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SurveyGuid IN (SELECT SurveyGuid FROM cy_Surveys ");
            ...
            sqlCommand.Append("DELETE FROM cy_Surveys ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SiteGuid IN (SELECT SiteGuid FROM cy_Sites WHERE SiteID = ?SiteID);");
            ...
            Guid surveyGuid)
        {
            ...
            sqlCommand.Append("(SELECT COUNT(*) FROM cy_SurveyPages sp WHERE sp.SurveyGuid = s.SurveyGuid) AS PageCount, ");
            sqlCommand.Append("(SELECT COUNT(*) FROM cy_SurveyResponses sr WHERE sr.SurveyGuid = s.SurveyGuid) AS ResponseCount ");
            sqlCommand.Append("FROM	cy_Surveys s ");
            sqlCommand.Append("WHERE ");
        ...
        public static int GetCount()
        {
            ...
            sqlCommand.Append("FROM	cy_Surveys; ");
        ...
        public static int GetResponseCount(Guid surveyGuid)
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("SELECT Count(*) ");
            sqlCommand.Append("FROM	cy_SurveyResponses ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SurveyGuid = ?SurveyGuid ");
        ...
        public static void AddToModule(Guid surveyGuid, int moduleId)
        {
            ...
            sqlCommand.Append("FROM cy_SurveyModules ");
            sqlCommand.Append("WHERE ModuleId = ?ModuleId; ");

            sqlCommand.Append("INSERT INTO cy_SurveyModules (SurveyGuid, ModuleId) ");
        ...
        public static IDataReader GetResults(Guid surveyGuid)
        {
            ...
            sqlCommand.Append("FROM cy_SurveyQuestionAnswers qa ");

            sqlCommand.Append("JOIN cy_SurveyResponses sr ");
        ...
        public static IDataReader GetOneResult(Guid responseGuid)
        {
            ...
            sqlCommand.Append("JOIN cy_SurveyPages sp ");
            sqlCommand.Append("ON sr.SurveyGuid = sp.SurveyGuid ");

            sqlCommand.Append("JOIN cy_SurveyQuestions sq ");
            sqlCommand.Append("ON sp.PageGuid = sq.PageGuid ");

            sqlCommand.Append("LEFT JOIN cy_SurveyQuestionAnswers qa ");
