...
namespace SurveyFeature.Data
{
    public static class DBQuestionAnswer
    {
            ...
            string answer)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_SurveyQuestionAnswers (");
            ...
            string answer)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_SurveyQuestionAnswers ");
        ...
        public static IDataReader GetOne(Guid responseGuid, Guid questionGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_SurveyQuestionAnswers ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("QuestionGuid = ?QuestionGuid ");
