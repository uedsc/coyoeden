...
namespace SurveyFeature.Data
{
    ...
    public static class DBQuestion
    {
        ...
        /// <summary>
        /// Deletes a row from the cy_SurveyQuestions table. Returns true if row deleted.
        /// </summary>
        /// <param name="questionGuid"> questionGuid </param>
        /// <returns>bool</returns>
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_SurveyQuestions table.
        /// </summary>
        /// <param name="questionGuid"> questionGuid </param>
        ...
        /// <summary>
        /// Gets an IDataReader with all rows in the cy_SurveyQuestions table.
        /// </summary>
