...
namespace SurveyFeature.Data
{
    public static class DBSurveyPage
    {
            ...
            bool pageEnabled)
        {
            ...
            //sqlCommand.Append("SELECT ?PageCount = COUNT(*) FROM cy_SurveyPages; ");
            sqlCommand.Append("INSERT INTO cy_SurveyPages ");
            ...
            sqlCommand.Append("Count(*), ?PageEnabled FROM cy_SurveyPages; ");
            ...
            bool pageEnabled)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_SurveyPages ");
            ...
            Guid pageGuid)
        {
            ...
            sqlCommand.Append("(SELECT COUNT(*) FROM cy_SurveyQuestions sq WHERE sp.PageGuid = sq.PageGuid) AS QuestionCount ");
            sqlCommand.Append("FROM	cy_SurveyPages sp ");
            sqlCommand.Append("WHERE ");
        ...
        /// <summary>
        /// Gets a count of rows in the cy_SurveyPages table.
        /// </summary>
