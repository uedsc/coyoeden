...
namespace Cynthia.Data
{
    public static class DBGallery
    {
            ...
            Guid userGuid)
        {
            ...
            arParams[4] = new MySqlParameter("?MetaDataXml", MySqlDbType.Text);
            ...
            string uploadUser)
        {
            ...
            sqlCommand.Append("UPDATE cy_GalleryImages ");
            ...
            arParams[5] = new MySqlParameter("?MetaDataXml", MySqlDbType.Text);
            arParams[5].Direction = ParameterDirection.Input;
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_GalleryImages ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ItemID = ?ItemID ;");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_GalleryImages WHERE ModuleID = ?ModuleID;");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_GalleryImages WHERE ModuleID IN (SELECT ModuleID FROM cy_Modules WHERE SiteID = ?SiteID);");
        ...
        public static IDataReader GetImagesByPage(int siteId, int pageId)
        {
            ...
            sqlCommand.Append("FROM	cy_GalleryImages ce ");
