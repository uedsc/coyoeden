...
<div class="post itemview xfolkentry">
	...
	<img alt="<%=Server.HtmlEncode(Post.Title) %>" src="<%=Icon %>"/>
	</a>
	<%} %>
	<div class="item_main">
	...
	<span class="counts"><a title="" href="/post/show.aspx?id=<%=Post.Id %>#c"><%=Post.ApprovedComments.Count %>个评论<em>|</em><%=Post.Raters.Value %>人推荐</a></span>
