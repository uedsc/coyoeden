Running CoyoEden.NET 1.5 using MySQL 5.1:
...
included is an upgrade script for users of CoyoEden 1.4.5.  In addition, you 
...
want to add the CoyoEden data to.  This can be a new or existing database.
...
you have a backup.)'
3. Update the CoyoEden connection string in the web.config.
