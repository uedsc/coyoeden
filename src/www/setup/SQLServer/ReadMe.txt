Running CoyoEden.NET 1.5 using SQL Server 2005:
...
included is an upgrade script for users of CoyoEden 1.4.5.0.  In addition, you 
...
3. Execute the Setup script against the database you want to add the CoyoEden data to.
...
you have a backup.)
5. Update the CoyoEden connection string in the web.config.
...
1. Open SQL Server Management Studio and connect to your SQL Server.
2. Execute the desired upgrade script against the database where you have your CoyoEden
data.
