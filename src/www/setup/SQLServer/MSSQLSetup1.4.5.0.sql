/****** CoyoEden.NET 1.4.5 SQL Setup Script ******/
...
INSERT INTO be_Settings (SettingName, SettingValue)	VALUES ('endorsement', 'http://www.dotnetCoyoEden.net/syndication.axd');
...
INSERT INTO be_Settings (SettingName, SettingValue)	VALUES ('IsCommentEnabled', 'True');
...
INSERT INTO be_Posts (PostID, Title, Description, PostContent, DateCreated, Author, IsPublished)
	VALUES (@postID, 
	'Welcome to CoyoEden.NET 1.4.5 using Microsoft SQL Server', 
	...
	'<p>If you see this post it means that CoyoEden.NET 1.4.5 is running with SQL Server and the DbBlogProvider is configured correctly.</p>
	<h2>Setup</h2>
