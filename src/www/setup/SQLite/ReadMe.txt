Running CoyoEden.NET 1.5 using SQLite:
...
who wish to upgrade from 1.4.5 to 1.5
...
3. Copy CoyoEden.s3db from the SQLite folder to your App_Data folder.
...
2. Open your CoyoEden.s3db database.  (You will likely need to copy your CoyoEden.s3db
file from your web server, perform the update, and copy it back out after these changes
depending on your setup.)
3. Execute the upgrade script against the database.
...
5. The web.config file has changed in 1.5.0.  It will likely be easiest to start
