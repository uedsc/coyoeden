...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
    ...
    <div class="settings">
      ...
      <input type="button" value="<%=Resources.labels.import %>" onclick="location.href='http://vivasky.com/clickonce/blogimporter/blog.importer.application?url=<%=Utils.AbsoluteWebRoot %>&username=<%=Page.User.Identity.Name %>'" />&nbsp;&nbsp;
