...
public class apmlchecker : IHttpHandler
{
  ...
  public void ProcessRequest(HttpContext context)
  {
    ...
    CoyoEden.Core.Web.HttpModules.CompressionModule.CompressResponse(context);
  ...
  private static Uri RetrieveApmlUrl(HttpContext context, string website)
  {
    ...
    {
      Dictionary<Uri, XmlDocument> docs = SystemX.Web.Utils.FindSemanticDocuments(url, "apml");
      if (docs.Count > 0)
      {
