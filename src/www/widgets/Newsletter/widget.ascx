...
<script type="text/javascript">
  function beginAddEmail()
  {
    ...
    var arg = CoyoEden.$('<%=txtEmail.ClientID %>').value;
  ...
  {
    CoyoEden.$('newsletterform').style.display = 'none';
    CoyoEden.$('newsletterthanks').style.display = 'block';
    if (arg == "false")
    {
      CoyoEden.$('newsletteraction').innerHTML = "You are now unsubscribed";
    }
  }
</script>