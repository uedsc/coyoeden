...
public partial class widgets_Tag_cloud_widget : WidgetBase
{
	...
	public override void LoadWidget()
	{
		foreach (string key in WeightedList.Keys)
		{
			...
			li.InnerHtml = string.Format(LINK, String.Format("{0}?tag=/{1}", Utils.RelativeWebRoot, Utils.RemoveIllegalCharacters(key)), WeightedList[key], "Tag: " + key, key);
