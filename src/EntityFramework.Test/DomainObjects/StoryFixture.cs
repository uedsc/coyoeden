...
namespace Kigg.Infrastructure.EF.Test
{
    ...
    public class StoryFixture : EfBaseFixture
    {
        ...
        public StoryFixture()
        {
            ...
            _mockedTags = new Mock<EntityCollection<ITag, Tag>>(_story.Tag);
            _mockedVotes = new Mock<EntityCollection<IVote, StoryVote>>(_story.StoryVote);
            _mockedMarkAsSpam = new Mock<EntityCollection<IMarkAsSpam, StoryMarkAsSpam>>(_story.StoryMarkAsSpam);
            _mockedViews = new Mock<EntityCollection<IStoryView, StoryView>>(_story.StoryView);
            _mockedComments = new Mock<EntityCollection<IComment, StoryComment>>(_story.StoryComment);
            _mockedUsers = new Mock<EntityCollection<IUser, User>>(_story.User1);

            _story.StoryTags = _mockedTags.Object;
            _story.StoryVotes = _mockedVotes.Object;
            _story.StoryMarkAsSpam_ = _mockedMarkAsSpam.Object;
        ...
        public void AddTag_Should_Increase_Tags_Collection()
        {
            ...
            Assert.Equal(1, _story.Tag.Count);
        ...
        public void RemoveTag_Should_Decrease_Tags_Collection()
        {
            ...
            Assert.Equal(0, _story.Tag.Count);
        ...
        public void RemoveAllTag_Should_Clear_Tags_Collection()
        {
            ...
            Assert.Equal(3, _story.Tag.Count);
            Assert.Equal(3, _story.Tags.Count);

            _story.RemoveAllTags();

            Assert.Empty(_story.Tag);
            Assert.Empty(_story.Tags);
        }
        ...
        public void View_Should_Increase_Views_Collection()
        {
            ...
            Assert.Equal(1, _story.StoryView.Count);
        }
        ...
        public void Promote_Should_Increase_Votes_Collection()
        {
            ...
            Assert.Equal(1, _story.StoryVote.Count);
        ...
        public void Demote_Should_Decrease_Votes_Collection()
        {
            ...
            Assert.Equal(0, _story.StoryVote.Count);
        ...
        public void MarkAsSpam_Should_Increase_MarkAsSpams_Collection()
        {
            ...
            Assert.Equal(1, _story.StoryMarkAsSpam.Count);
        ...
        public void UnmarkAsSpam_Should_Decrease_MarkAsSpams_Collection()
        {
            ...
            markAsSpamRepository.Setup(r => r.FindById(It.IsAny<Guid>(), It.IsAny<Guid>())).Returns(_story.StoryMarkAsSpam.ElementAt(0));

            _story.UnmarkAsSpam(SystemTime.Now(), user);

            Assert.Equal(0, _story.StoryMarkAsSpam.Count);
        ...
        public void PostComment_Should_Increase_Comments_Collection()
        {
            ...
            Assert.Equal(1, _story.StoryComment.Count);
        ...
        public void DeleteComment_Should_Decrease_Comment_Collection()
        {
            ...
            Assert.Equal(0, _story.StoryComment.Count);
        ...
        public void UnsubscribeComment_Should_Decrease_Subscribers()
        {
            ...
            Assert.Equal(0, _story.User1.Count);
