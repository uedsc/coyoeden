	...
	public class BlogMLExportHandler : IHttpHandler
	{
		...
		private static void AddPosts(XmlWriter writer)
		{
			...
			foreach (Post post in Post.Posts)
			{
				...
				writer.WriteAttributeString("date-created", post.DateCreated.Value.ToString("yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture));
				writer.WriteAttributeString("date-modified", post.DateModified.Value.ToString("yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture));
				writer.WriteAttributeString("approved", "true");
		...
		private static void AddPostComments(XmlWriter writer, Post post)
		{
			...
			foreach (var comment in post.Comments)
			{
				...
				writer.WriteAttributeString("date-created", comment.DateCreated.Value.ToString("yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture));
				writer.WriteAttributeString("date-modified", comment.DateCreated.Value.ToString("yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture));
