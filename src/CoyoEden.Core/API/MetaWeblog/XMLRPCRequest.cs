...
namespace CoyoEden.Core.API.MetaWeblog
{
    ...
    internal class XMLRPCRequest
    {
      ...
      /// </summary>
      /// <remarks>
      /// CoyoEden.NET doesn't require specific AppKeys for API calls.  It is no longer standard practive.
      /// </remarks>
      ...
      /// <summary>
      /// ID of the Blog to call the function on.  Since CoyoEden supports only a single blog instance,
      ...
      /// <summary>
      /// Publish determines wheter or not a post will be marked as published by CoyoEden.
      /// </summary>
      public bool Publish
      {
        get { return _publish; }
