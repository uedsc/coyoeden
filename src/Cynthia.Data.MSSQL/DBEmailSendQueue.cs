...
namespace Cynthia.Data
{
    ...
    public static class DBEmailSendQueue
    {
        ...
        public static int Create(
            ...
            DateTime createdUtc)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_EmailSendQueue_Insert", 17);
        ...
        /// <summary>
        /// Deletes a row from the cy_EmailSendQueue table. Returns true if row deleted.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_EmailSendQueue_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_EmailSendQueue_SelectForSending", 1);
