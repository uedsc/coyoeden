...
namespace Cynthia.Data
{
    ...
    public static class DBLanguage
    {
        ...
        public static int Create(
            ...
            int sort)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Language_Insert", 4);
        ...
        public static bool Update(
            ...
            int sort)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Language_Update", 4);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@Name", SqlDbType.NVarChar, 255, ParameterDirection.Input, name);
            sph.DefineSqlParameter("@Code", SqlDbType.NChar, 2, ParameterDirection.Input, code);
            sph.DefineSqlParameter("@Sort", SqlDbType.Int, ParameterDirection.Input, sort);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Language_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Language_SelectOne", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Language_SelectPage", 2);
