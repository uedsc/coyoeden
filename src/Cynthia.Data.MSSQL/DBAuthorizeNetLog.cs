...
namespace Cynthia.Data
{
    ...
    public static class DBAuthorizeNetLog
    {
        ...
        public static int Create(
            ...
            decimal freight)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_AuthorizeNetLog_Insert", 21);
            ...
            sph.DefineSqlParameter("@Reason", SqlDbType.NText, ParameterDirection.Input, reason);
        ...
        public static bool Update(
            ...
            decimal freight)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_AuthorizeNetLog_Update", 20);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
        ...
        /// <summary>
        /// Deletes a row from the cy_AuthorizeNetLog table. Returns true if row deleted.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid rowGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_AuthorizeNetLog_Delete", 1);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_AuthorizeNetLog table.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        public static IDataReader GetOne(Guid rowGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_AuthorizeNetLog_SelectOne", 1);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
        ...
        /// <summary>
        /// Gets an IDataReader with rows from the cy_AuthorizeNetLog table.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        public static IDataReader GetByCart(Guid cartGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_AuthorizeNetLog_SelectByCart", 1);
            sph.DefineSqlParameter("@CartGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, cartGuid);
            return sph.ExecuteReader();
        ...
        public static int GetCount()
        {
            ...
            return Convert.ToInt32(SqlHelper.ExecuteScalar(
                ...
                "cy_AuthorizeNetLog_GetCount",
                null));

        }

        /// <summary>
        /// Gets an IDataReader with all rows in the cy_AuthorizeNetLog table.
        /// </summary>
        public static IDataReader GetAll()
        {
            ...
            return SqlHelper.ExecuteReader(
                GetConnectionString(),
                CommandType.StoredProcedure,
                "cy_AuthorizeNetLog_SelectAll",
                null);

        }

        /// <summary>
        /// Gets a page of data from the cy_AuthorizeNetLog table.
        /// </summary>
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_AuthorizeNetLog_SelectPage", 2);
