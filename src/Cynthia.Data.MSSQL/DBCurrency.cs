namespace Cynthia.Data
{
    ...
    public static class DBCurrency
    {
        ...
        public static int Create(
            ...
            DateTime created)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Currency_Insert", 11);
        ...
        /// <summary>
        /// Updates a row in the cy_Currency table. Returns true if row updated.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <param name="title"> title </param>
        /// <param name="code"> code </param>
        ...
        public static bool Update(
            ...
            DateTime lastModified)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Currency_Update", 10);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 50, ParameterDirection.Input, title);
            sph.DefineSqlParameter("@Code", SqlDbType.NChar, 3, ParameterDirection.Input, code);
            sph.DefineSqlParameter("@SymbolLeft", SqlDbType.NVarChar, 15, ParameterDirection.Input, symbolLeft);
        ...
        /// <summary>
        /// Deletes a row from the cy_Currency table. Returns true if row deleted.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Currency_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_Currency table.
        /// </summary>
        /// <param name="guid"> guid </param>
        public static IDataReader GetOne(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_Currency_SelectOne", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
        ...
        /// <summary>
        /// Gets an IDataReader with all rows in the cy_Currency table.
        /// </summary>
