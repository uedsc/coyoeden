...
namespace Cynthia.Data
{
    ...
    public static class DBUserPage
    {
        ...
        public static int AddUserPage(
            ...
            int pageOrder)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_Insert", 7);
        ...
        public static bool UpdateUserPage(
            ...
            int pageOrder)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_Update", 3);
            sph.DefineSqlParameter("@UserPageID", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userPageId);
            sph.DefineSqlParameter("@PageName", SqlDbType.NVarChar, ParameterDirection.Input, pageName);
            sph.DefineSqlParameter("@PageOrder", SqlDbType.Int, ParameterDirection.Input, pageOrder);
            int rowsAffected = sph.ExecuteNonQuery();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_Delete", 1);
            sph.DefineSqlParameter("@UserPageID", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userPageId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_SelectOne", 1);
            sph.DefineSqlParameter("@UserPageID", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userPageId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_SelectByUser", 1);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_GetNextPageOrder", 1);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_UserPages_UpdatePageOrder", 2);
            sph.DefineSqlParameter("@UserPageID", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userPageId);
            sph.DefineSqlParameter("@PageOrder", SqlDbType.Int, ParameterDirection.Input, pageOrder);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
