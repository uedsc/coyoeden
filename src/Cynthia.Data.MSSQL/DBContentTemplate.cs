...
namespace Cynthia.Data
{
    ...
    public static class DBContentTemplate
    {
        ...
        /// <summary>
        /// Inserts a row in the cy_ContentTemplate table. Returns rows affected count.
        /// </summary>
        ...
        public static int Create(
            ...
            DateTime createdUtc)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentTemplate_Insert", 11);
            ...
            sph.DefineSqlParameter("@Body", SqlDbType.NText, ParameterDirection.Input, body);
            sph.DefineSqlParameter("@AllowedRoles", SqlDbType.NText, ParameterDirection.Input, allowedRoles);
        ...
        /// <summary>
        /// Updates a row in the cy_ContentTemplate table. Returns true if row updated.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <param name="siteGuid"> siteGuid </param>
        /// <param name="title"> title </param>
        ...
        public static bool Update(
            ...
            DateTime lastModUtc)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentTemplate_Update", 9);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 255, ParameterDirection.Input, title);
            sph.DefineSqlParameter("@ImageFileName", SqlDbType.NVarChar, 255, ParameterDirection.Input, imageFileName);
        ...
        /// <summary>
        /// Deletes a row from the cy_ContentTemplate table. Returns true if row deleted.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentTemplate_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_ContentTemplate table.
        /// </summary>
        /// <param name="guid"> guid </param>
        public static IDataReader GetOne(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentTemplate_SelectOne", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
        ...
        /// <summary>
        /// Gets a count of rows in the cy_ContentTemplate table.
        /// </summary>
        public static int GetCount(Guid siteGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentTemplate_GetCount", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
        ...
        /// <summary>
        /// Gets an IDataReader with all rows in the cy_ContentTemplate table.
        /// </summary>
        public static IDataReader GetAll(Guid siteGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentTemplate_SelectAll", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            return sph.ExecuteReader();
        ...
        /// <summary>
        /// Gets a page of data from the cy_ContentTemplate table.
        /// </summary>
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentTemplate_SelectPage", 3);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
