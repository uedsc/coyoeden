...
namespace Cynthia.Data
{
    ...
    public static class DBContentMetaLink
    {
        ...
        public static int Create(
            ...
            Guid createdBy)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentMetaLink_Insert", 15);
        ...
        public static bool Update(
            ...
            Guid lastModBy)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentMetaLink_Update", 10);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@Rel", SqlDbType.NVarChar, 255, ParameterDirection.Input, rel);
            sph.DefineSqlParameter("@Href", SqlDbType.NVarChar, 255, ParameterDirection.Input, href);
            sph.DefineSqlParameter("@HrefLang", SqlDbType.NVarChar, 10, ParameterDirection.Input, hrefLang);
        ...
        /// <summary>
        /// Deletes a row from the cy_ContentMetaLink table. Returns true if row deleted.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentMetaLink_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Deletes rows from the cy_ContentMetaLink table. Returns true if rows deleted.
        /// </summary>
        /// <param name="siteGuid"> guid </param>
        /// <returns>bool</returns>
        public static bool DeleteBySite(Guid siteGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentMetaLink_DeleteBySite", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentMetaLink_DeleteByModule", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_ContentMetaLink_DeleteByContent", 1);
            sph.DefineSqlParameter("@ContentGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, contentGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_ContentMetaLink table.
        /// </summary>
        /// <param name="guid"> guid </param>
        public static IDataReader GetOne(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentMetaLink_SelectOne", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
        ...
        /// <summary>
        /// Gets an IDataReader with rows from the cy_ContentMetaLink table.
        /// </summary>
        /// <param name="contentGuid"> guid </param>
        public static IDataReader GetByContent(Guid contentGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentMetaLink_SelectByContent", 1);
            sph.DefineSqlParameter("@ContentGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, contentGuid);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_ContentMetaLink_GetMaxSortOrder", 1);
            sph.DefineSqlParameter("@ContentGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, contentGuid);
