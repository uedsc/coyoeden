...
namespace Cynthia.Data
{
    ...
    public static class DBLetterSendLog
    {
        ...
        public static int Create(
            ...
            string errorMessage)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_Insert", 7);
        ...
        /// <summary>
        /// Updates a row in the cy_LetterSendLog table. Returns true if row updated.
        /// </summary>
        ...
        public static bool Update(
            ...
            string errorMessage)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_Update", 7);
        ...
        /// <summary>
        /// Deletes a row from the cy_LetterSendLog table. Returns true if row deleted.
        /// </summary>
        /// <param name="rowID"> rowID </param>
        /// <returns>bool</returns>
        public static bool Delete(int rowId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_Delete", 1);
            sph.DefineSqlParameter("@RowID", SqlDbType.Int, ParameterDirection.Input, rowId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Deletes from the cy_LetterSendLog table for the letterGuid. Returns true if row deleted.
        /// </summary>
        /// <param name="letterGuid"> letterGuid </param>
        /// <returns>bool</returns>
        public static bool DeleteByLetter(Guid letterGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_DeleteByLetter", 1);
            sph.DefineSqlParameter("@LetterGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_DeleteByLetterInfo", 1);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_DeleteBySite", 1);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_LetterSendLog table.
        /// </summary>
        /// <param name="rowID"> rowID </param>
        public static IDataReader GetOne(int rowId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_SelectOne", 1);
            sph.DefineSqlParameter("@RowID", SqlDbType.Int, ParameterDirection.Input, rowId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_GetCount", 1);
            sph.DefineSqlParameter("@LetterGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_SelectByLetter", 1);
            sph.DefineSqlParameter("@LetterGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterGuid);
            return sph.ExecuteReader();
        ...
        /// <summary>
        /// Gets a page of data from the cy_LetterSendLog table.
        /// </summary>
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterSendLog_SelectPage", 3);
            sph.DefineSqlParameter("@LetterGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterGuid);
