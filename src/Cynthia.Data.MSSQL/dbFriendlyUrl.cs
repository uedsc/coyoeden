...
namespace Cynthia.Data
{
    ...
    public static class DBFriendlyUrl
    {
        ...
        public static int AddFriendlyUrl(
            ...
            bool isPattern)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_Insert", 7);
        ...
        public static bool UpdateFriendlyUrl(
            ...
            bool isPattern)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_Update", 6);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_Delete", 1);
            sph.DefineSqlParameter("@UrlID", SqlDbType.Int, ParameterDirection.Input, urlId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_DeleteByPageID", 1);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_DeleteByPageGuid", 1);
            sph.DefineSqlParameter("@PageGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, pageGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectOne", 1);
            sph.DefineSqlParameter("@UrlID", SqlDbType.Int, ParameterDirection.Input, urlId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectBySiteUrl", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@FriendlyUrl", SqlDbType.NVarChar, 255, ParameterDirection.Input, friendlyUrl);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectByHost", 1);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectBySiteID", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectOneByUrl", 2);
        ...
        public static bool Exists(
            ...
            string friendlyUrl)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_Exists", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@FriendlyUrl", SqlDbType.NVarChar, 255, ParameterDirection.Input, friendlyUrl);
        ...
        /// <summary>
        /// Gets a count of rows in the cy_FriendlyUrls table.
        /// </summary>
        public static int GetCount(int siteId)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_GetCount", 1);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_GetSearchCount", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectPage", 3);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_FriendlyUrls_SelectSearchPage", 34);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
            sph.DefineSqlParameter("@SearchTerm", SqlDbType.NVarChar, 255, ParameterDirection.Input, searchTerm);
            sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
            sph.DefineSqlParameter("@PageSize", SqlDbType.Int, ParameterDirection.Input, pageSize);
