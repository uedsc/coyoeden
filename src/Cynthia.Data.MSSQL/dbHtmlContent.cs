...
namespace Cynthia.Data
{
    ...
    public static class DBHtmlContent
    {
        ...
        public static int AddHtmlContent(
            ...
            Guid userGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_Insert", 13);
            ...
            sph.DefineSqlParameter("@Excerpt", SqlDbType.NText, ParameterDirection.Input, excerpt);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_Update", 11);
        ...
        //    SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_Approve", 5);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_Delete", 1);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_DeleteBySite", 1);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_DeleteByModule", 1);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_SelectOne", 1);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
        ...
        public static IDataReader GetHtmlContent(
                ...
                DateTime beginDate)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_Select", 2);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
            sph.DefineSqlParameter("@BeginDate", SqlDbType.DateTime, ParameterDirection.Input, beginDate);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_HtmlContent_SelectByPage", 2);
            sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
