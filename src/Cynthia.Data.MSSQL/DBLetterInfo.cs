...
namespace Cynthia.Data
{
    ...
    public static class DBLetterInfo
    {
        ...
        public static int Create(
            ...
            int sortRank)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_Insert", 24);
            ...
            sph.DefineSqlParameter("@AvailableToRoles", SqlDbType.NText, ParameterDirection.Input, availableToRoles);
            ...
            sph.DefineSqlParameter("@RolesThatCanEdit", SqlDbType.NText, ParameterDirection.Input, rolesThatCanEdit);
            sph.DefineSqlParameter("@RolesThatCanApprove", SqlDbType.NText, ParameterDirection.Input, rolesThatCanApprove);
            sph.DefineSqlParameter("@RolesThatCanSend", SqlDbType.NText, ParameterDirection.Input, rolesThatCanSend);
        ...
        public static bool Update(
            ...
            int sortRank)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_Update", 24);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 255, ParameterDirection.Input, title);
            sph.DefineSqlParameter("@Description", SqlDbType.NText, ParameterDirection.Input, description);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_UpdateSubscriberCount", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        }
        ...
        public static bool Delete(
            Guid letterInfoGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_Delete", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        public static IDataReader GetOne(
            Guid letterInfoGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_SelectOne", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_GetCount", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_SelectAll", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            return sph.ExecuteReader();
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_LetterInfo_SelectPage", 3);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
