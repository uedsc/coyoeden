...
namespace Cynthia.Data
{
    ...
    public static class DBPayPalLog
    {
        ...
        public static int Create(
            ...
            string response)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_Insert", 29);
            ...
            sph.DefineSqlParameter("@SerializedObject", SqlDbType.NText, ParameterDirection.Input, serializedObject);
        ...
        public static bool Update(
            ...
            decimal settleAmt)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_Update", 23);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
            sph.DefineSqlParameter("@CreatedUtc", SqlDbType.DateTime, ParameterDirection.Input, createdUtc);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
        ...
        /// <summary>
        /// Deletes a row from the cy_PayPalLog table. Returns true if row deleted.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid rowGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_Delete", 1);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_PayPalLog table.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        public static IDataReader GetOne(Guid rowGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_SelectOne", 1);
            sph.DefineSqlParameter("@RowGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, rowGuid);
        ...
        /// <summary>
        /// Gets an IDataReader with rows from the cy_PayPalLog table.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        public static IDataReader GetByCart(Guid cartGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_SelectByCart", 1);
            sph.DefineSqlParameter("@CartGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, cartGuid);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_SelectSetExpressCheckoutByToken", 1);
            sph.DefineSqlParameter("@Token", SqlDbType.NVarChar, 50, ParameterDirection.Input, token);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_SelectNewestLog", 2);
            sph.DefineSqlParameter("@CartGuid", SqlDbType.UniqueIdentifier,  ParameterDirection.Input, cartGuid);
            sph.DefineSqlParameter("@RequestType", SqlDbType.NVarChar, 255, ParameterDirection.Input, requestType);
            return sph.ExecuteReader();
        ...
        /// <summary>
        /// Gets a count of rows in the cy_PayPalLog table.
        /// </summary>
        public static int GetCount()
        {
            ...
            return Convert.ToInt32(SqlHelper.ExecuteScalar(
                ...
                "cy_PayPalLog_GetCount",
                null));

        }

        /// <summary>
        /// Gets an IDataReader with all rows in the cy_PayPalLog table.
        /// </summary>
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_PayPalLog_SelectPage", 2);
