...
namespace Cynthia.Data
{
    public static class DBLetterSubscription
    {
        ...
        /// <summary>
        /// Inserts a row in the cy_LetterSubscribe table. Returns rows affected count.
        /// </summary>
        ...
        public static int Create(
            ...
            string ipAddress)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_Insert", 10);
        ...
        /// <summary>
        /// Updates a row in the cy_LetterSubscribe table. Returns true if row updated.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <param name="useHtml"> useHtml </param>
        ...
        public static bool Update(
            ...
            bool useHtml)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_Update", 3);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            sph.DefineSqlParameter("@UseHtml", SqlDbType.Bit, ParameterDirection.Input, useHtml);
            int rowsAffected = sph.ExecuteNonQuery();
        ...
        /// <summary>
        /// Gets a count of rows in the cy_LetterSubscribe table.
        /// </summary>
        /// <param name="letterGuid"> letterGuid </param>
        public static bool Exists(Guid letterInfoGuid, string email)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_Exists", 2);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 100, ParameterDirection.Input, email);
        ...
        public static bool Verify(
            ...
            Guid verifyGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_Verify", 3);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            sph.DefineSqlParameter("@IsVerified", SqlDbType.Bit, ParameterDirection.Input, isVerified);
            sph.DefineSqlParameter("@VerifyGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, verifyGuid);
        ...
        /// <summary>
        /// Deletes a row from the cy_LetterSubscribe table. Returns true if row deleted.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <returns>bool</returns>
        public static bool Delete(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_Delete", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_DeleteByLetter", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_DeleteUnverified", 2);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_DeleteByUser", 1);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribe_DeleteBySite", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_LetterSubscribe table.
        /// </summary>
        /// <param name="guid"> guid </param>
        public static IDataReader GetOne(Guid guid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectOne", 1);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectByLetter", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectByUser", 2);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectByEmail", 2);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 100, ParameterDirection.Input, email);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_Search", 2);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectByLetterAndEmail", 3);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            sph.DefineSqlParameter("@Email", SqlDbType.NVarChar, 100, ParameterDirection.Input, email);
            return sph.ExecuteReader();
        ...
        /// <summary>
        /// Gets an IDataReader from the cy_LetterSubscriber table.
        /// </summary>
        /// <param name="letterInfoGuid"> letterInfoGuid </param>
        public static IDataReader GetSubscribersNotSentYet(
            ...
            Guid letterInfoGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectUnsentByLetter", 2);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_CountByLetter", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
        ...
        /// <summary>
        /// Gets a page of data from the cy_LetterSubscriber table.
        /// </summary>
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "cy_LetterSubscribe_SelectPage", 3);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
        ...
        public static int CreateHistory(
            ...
            string ipAddress)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribeHx_Insert", 11);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribeHx_DeleteBySite", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "cy_LetterSubscribeHx_DeleteByLetterInfo", 1);
            sph.DefineSqlParameter("@LetterInfoGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, letterInfoGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
