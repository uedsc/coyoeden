...
namespace Cynthia.Data
{
    public static class DBRssFeed
    {
        ...
        public static int AddRssFeed(
            ...
            int sortRank)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_Insert", 13);
        ...
        public static bool UpdateRssFeed(
            ...
            int sortRank)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_Update", 11);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_Delete", 1);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_DeleteByModule", 1);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > -1);
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_DeleteBySite", 1);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_SelectOne", 1);
            sph.DefineSqlParameter("@ItemID", SqlDbType.Int, ParameterDirection.Input, itemId);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeeds_Select", 1);
            sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
            return sph.ExecuteReader();
        }
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_RssFeedEntries table.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        public static IDataReader GetEntries(Guid moduleGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_SelectByModule", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_DeleteExpiredByModule", 2);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_DeleteUnPublishedByModule", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_DeleteByModule", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_DeleteUnPublishedByFeed", 1);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_DeleteByFeed", 1);
            sph.DefineSqlParameter("@FeedId", SqlDbType.Int, ParameterDirection.Input, feedId);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets a count of rows in the cy_RssFeedEntries table.
        /// </summary>
        public static bool EntryExists(Guid moduleGuid, int entryHash)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_GetHashCount", 2);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_GetLastCacheTime", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
        ...
        /// <summary>
        /// Inserts a row in the cy_RssFeedEntries table. Returns rows affected count.
        /// </summary>
        /// <param name="rowGuid"> rowGuid </param>
        /// <param name="moduleGuid"> moduleGuid </param>
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_Insert", 13);
        ...
        /// <summary>
        /// Updates a row in the cy_RssFeedEntries table. Returns true if row updated.
        /// </summary>
        /// <param name="moduleGuid"> moduleGuid </param>
        /// <param name="title"> title </param>
        /// <param name="author"> author </param>
        ...
        public static bool UpdateEnry(
            ...
            DateTime cachedTimeUtc)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_Update", 8);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 255, ParameterDirection.Input, title);
            sph.DefineSqlParameter("@Author", SqlDbType.NVarChar, 100, ParameterDirection.Input, author);
            sph.DefineSqlParameter("@BlogUrl", SqlDbType.NVarChar, 255, ParameterDirection.Input, blogUrl);
        ...
        public static bool UpdatePublishing(
            ...
            int entryHash)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_RssFeedEntries_UpdatePublishing", 3);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@EntryHash", SqlDbType.Int, ParameterDirection.Input, entryHash);
            sph.DefineSqlParameter("@Confirmed", SqlDbType.Bit, ParameterDirection.Input, confirmed);
