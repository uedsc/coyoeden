...
namespace SurveyFeature.Data
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(DBSurveyPage));
        ...
        /// <summary>
        /// Inserts a row in the cy_SurveyPages table. Returns rows affected count.
        /// </summary>
        ...
        public static int Add(
            ...
            bool pageEnabled)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_SurveyPages_Insert", 4);
        ...
        /// <summary>
        /// Updates a row in the cy_SurveyPages table. Returns true if row updated.
        /// </summary>
        ...
        public static bool Update(
            ...
            bool pageEnabled)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_SurveyPages_Update", 5);
        ...
        /// <summary>
        /// Deletes a row from the cy_SurveyPages table. Returns true if row deleted.
        /// </summary>
        /// <param name="surveyPageGuid"> surveyPageGuid </param>
        /// <returns>bool</returns>
        public static bool Delete(
            Guid surveyPageGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_SurveyPages_Delete", 1);
            sph.DefineSqlParameter("@PageGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, surveyPageGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_SurveyPages table.
        /// </summary>
        /// <param name="surveyPageGuid"> surveyPageGuid </param>
        public static IDataReader GetOne(
            Guid surveyPageGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_SurveyPages_SelectOne", 1);
            sph.DefineSqlParameter("@PageGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, surveyPageGuid);
        ...
        /// <summary>
        /// Gets an IDataReader with all rows in the cy_SurveyPages table.
        /// </summary>
        public static IDataReader GetAll(Guid surveyGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_SurveyPages_SelectAll", 1);
            sph.DefineSqlParameter("@SurveyGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, surveyGuid);
            return sph.ExecuteReader();
        }
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "cy_SurveyPages_CountQuestions", 1);
            sph.DefineSqlParameter("@PageGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, pageGuid);
