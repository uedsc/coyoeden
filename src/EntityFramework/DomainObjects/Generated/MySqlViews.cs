...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets51C9678E15CD567E5D01F4E928F0982A))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets51C9678E15CD567E5D01F4E928F0982A : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// 构造函数为盘区以及基于元数据和映射结束参数及视图生成的哈希值存储视图
        /// </Summary>
        public ViewsForBaseEntitySets51C9678E15CD567E5D01F4E928F0982A()
        {
            this.EdmEntityContainerName = "KiggEntityContainer";
            this.StoreEntityContainerName = "KiggStorageEntityContainer";
            this.HashOverMappingClosure = "f5bf384b58759c1025f956407d1b42f5";
        ...
        protected override System.Collections.Generic.KeyValuePair<string, string> GetViewAt(int index)
        {
            if ((index == 0))
            {
                // 返回 KiggStorageEntityContainer.Category 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.Category AS T
            ...
            else
            {
                if ((index == 1))
                {
                    // 返回 KiggStorageEntityContainer.Story 的视图
                ...
                else
                {
                    if ((index == 2))
                    {
                        // 返回 KiggStorageEntityContainer.StoryComment 的视图
                    ...
                    else
                    {
                        if ((index == 3))
                        {
                            // 返回 KiggStorageEntityContainer.StoryMarkAsSpam 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.StoryMarkAsSpam AS T
                        ...
                        else
                        {
                            if ((index == 4))
                            {
                                // 返回 KiggStorageEntityContainer.StoryView 的视图
        ...
        FROM  (
            ...
            ON T1.StoryView_Id = T2.StoryView_Id
                            ...
                            else
                            {
                                if ((index == 5))
                                {
                                    // 返回 KiggStorageEntityContainer.StoryVote 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.StoryVote AS T
                                ...
                                else
                                {
                                    if ((index == 6))
                                    {
                                        // 返回 KiggStorageEntityContainer.Tag 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.Tag AS T
                                    ...
                                    else
                                    {
                                        if ((index == 7))
                                        {
                                            // 返回 KiggStorageEntityContainer.User 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.UserDataSource AS T
                                        ...
                                        else
                                        {
                                            if ((index == 8))
                                            {
                                                // 返回 KiggStorageEntityContainer.UserScore 的视图
        ...
        FROM  (
            ...
            ON T1.UserScore_Id = T2.UserScore_Id
                                            ...
                                            else
                                            {
                                                if ((index == 9))
                                                {
                                                    // 返回 KiggStorageEntityContainer.CommentSubscribtion 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.CommentSubscribtion AS T
                                                ...
                                                else
                                                {
                                                    if ((index == 10))
                                                    {
                                                        // 返回 KiggStorageEntityContainer.StoryTag 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.StoryTag AS T
                                                    ...
                                                    else
                                                    {
                                                        if ((index == 11))
                                                        {
                                                            // 返回 KiggStorageEntityContainer.UserTag 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.UserTag AS T
                                                        ...
                                                        else
                                                        {
                                                            if ((index == 12))
                                                            {
                                                                // 返回 KiggEntityContainer.Category 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.Category AS T
                                                            ...
                                                            else
                                                            {
                                                                if ((index == 13))
                                                                {
                                                                    // 返回 KiggEntityContainer.Story 的视图
                                                                ...
                                                                else
                                                                {
                                                                    if ((index == 14))
                                                                    {
                                                                        // 返回 KiggEntityContainer.StoryComment 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.StoryComment AS T
                                                                    ...
                                                                    else
                                                                    {
                                                                        if ((index == 15))
                                                                        {
                                                                            // 返回 KiggEntityContainer.StoryMarkAsSpam 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.StoryMarkAsSpam AS T
                                                                        ...
                                                                        else
                                                                        {
                                                                            if ((index == 16))
                                                                            {
                                                                                // 返回 KiggEntityContainer.StoryView 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.StoryView AS T
                                                                            ...
                                                                            else
                                                                            {
                                                                                if ((index == 17))
                                                                                {
                                                                                    // 返回 KiggEntityContainer.StoryVote 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.StoryVote AS T
                                                                                ...
                                                                                else
                                                                                {
                                                                                    if ((index == 18))
                                                                                    {
                                                                                        // 返回 KiggEntityContainer.Tag 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.Tag AS T
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                        if ((index == 19))
                                                                                        {
                                                                                            // 返回 KiggEntityContainer.UserDataSource 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.User AS T
                                                                                        ...
                                                                                        else
                                                                                        {
                                                                                            if ((index == 20))
                                                                                            {
                                                                                                // 返回 KiggEntityContainer.UserScore 的视图
    ...
    FROM (
        ...
        FROM KiggStorageEntityContainer.UserScore AS T
                                                                                            ...
                                                                                            else
                                                                                            {
                                                                                                if ((index == 21))
                                                                                                {
                                                                                                    // 返回 KiggEntityContainer.FK_Story_Category 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.Story AS T
                                                                                                ...
                                                                                                else
                                                                                                {
                                                                                                    if ((index == 22))
                                                                                                    {
                                                                                                        // 返回 KiggEntityContainer.FK_Story_User 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.Story AS T
                                                                                                    ...
                                                                                                    else
                                                                                                    {
                                                                                                        if ((index == 23))
                                                                                                        {
                                                                                                            // 返回 KiggEntityContainer.FK_StoryComment_Story 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryComment AS T
                                                                                                        ...
                                                                                                        else
                                                                                                        {
                                                                                                            if ((index == 24))
                                                                                                            {
                                                                                                                // 返回 KiggEntityContainer.FK_StoryMarkAsSpam_Story 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryMarkAsSpam AS T
                                                                                                            ...
                                                                                                            else
                                                                                                            {
                                                                                                                if ((index == 25))
                                                                                                                {
                                                                                                                    // 返回 KiggEntityContainer.FK_StoryView_Story 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryView AS T
                                                                                                                ...
                                                                                                                else
                                                                                                                {
                                                                                                                    if ((index == 26))
                                                                                                                    {
                                                                                                                        // 返回 KiggEntityContainer.FK_StoryVote_Story 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryVote AS T
                                                                                                                    ...
                                                                                                                    else
                                                                                                                    {
                                                                                                                        if ((index == 27))
                                                                                                                        {
                                                                                                                            // 返回 KiggEntityContainer.FK_StoryComment_User 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryComment AS T
                                                                                                                        ...
                                                                                                                        else
                                                                                                                        {
                                                                                                                            if ((index == 28))
                                                                                                                            {
                                                                                                                                // 返回 KiggEntityContainer.FK_StoryMarkAsSpam_User 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryMarkAsSpam AS T
                                                                                                                            ...
                                                                                                                            else
                                                                                                                            {
                                                                                                                                if ((index == 29))
                                                                                                                                {
                                                                                                                                    // 返回 KiggEntityContainer.FK_StoryVote_User 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryVote AS T
                                                                                                                                ...
                                                                                                                                else
                                                                                                                                {
                                                                                                                                    if ((index == 30))
                                                                                                                                    {
                                                                                                                                        // 返回 KiggEntityContainer.FK_UserScore_User 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.UserScore AS T
                                                                                                                                    ...
                                                                                                                                    else
                                                                                                                                    {
                                                                                                                                        if ((index == 31))
                                                                                                                                        {
                                                                                                                                            // 返回 KiggEntityContainer.CommentSubscribtion 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.CommentSubscribtion AS T
                                                                                                                                        ...
                                                                                                                                        else
                                                                                                                                        {
                                                                                                                                            if ((index == 32))
                                                                                                                                            {
                                                                                                                                                // 返回 KiggEntityContainer.StoryTag 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.StoryTag AS T
                                                                                                                                            ...
                                                                                                                                            else
                                                                                                                                            {
                                                                                                                                                if ((index == 33))
                                                                                                                                                {
                                                                                                                                                    // 返回 KiggEntityContainer.UserTag 的视图
            ...
            FROM (
                ...
                FROM KiggStorageEntityContainer.UserTag AS T
                                                                                                                                                ...
                                                                                                                                                else
                                                                                                                                                {
                                                                                                                                                    if ((index == 34))
                                                                                                                                                    {
                                                                                                                                                        // 返回 KiggStorageEntityContainer.KnownSource 的视图
    ...
    FROM (
        ...
        FROM KiggEntityContainer.KnownSource AS T
                                                                                                                                                    ...
                                                                                                                                                    else
                                                                                                                                                    {
                                                                                                                                                        if ((index == 35))
                                                                                                                                                        {
                                                                                                                                                            // 返回 KiggEntityContainer.KnownSource 的视图
