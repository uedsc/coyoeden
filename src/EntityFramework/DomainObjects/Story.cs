namespace Kigg.EF.DomainObjects
{
    ...
    public partial class Story : IStory
    {
        ...
        internal IEntityCollection<ITag> StoryTags
        {
            get
            {
                EntityHelper.EnsureEntityCollection(ref _storyTags, Tag);
        ...
        internal IEntityCollection<IVote> StoryVotes
        {
            get
            {
                EntityHelper.EnsureEntityCollection(ref _storyVotes, StoryVote);
        ...
        internal IEntityCollection<IMarkAsSpam> StoryMarkAsSpam_
        {
            get
            {
                EntityHelper.EnsureEntityCollection(ref _storyMarkAsSpam, StoryMarkAsSpam);
        ...
        internal IEntityCollection<IStoryView> StoryViews
        {
            get
            {
                EntityHelper.EnsureEntityCollection(ref _storyViews, StoryView);
        ...
        internal IEntityCollection<IComment> StoryComments
        {
            get
            {
                EntityHelper.EnsureEntityCollection(ref _storyComments, StoryComment);
        ...
        internal IEntityCollection<IUser> CommentSubscribers
        {
            get
            {
                EntityHelper.EnsureEntityCollection(ref _commentSubscribers, User1);
        ...
        public ICollection<IMarkAsSpam> MarkAsSpams
        {
            ...
            get
            {
                return StoryMarkAsSpam_.OrderBy(s => s.MarkedAt).ToList().AsReadOnly();
            }
        }
        ...
        public bool ContainsTag(ITag tag)
        {
            ...
            return Tag.Any(t => t.Name == tagName) || (srcQuery != null && srcQuery.Any(t => t.Name == tagName));
        }
        ...
        public bool Demote(DateTime at, IUser byUser)
        {
            ...
            if (CanDemote(byUser))
            {
                ...
                StoryVote.Remove((StoryVote)vote);
        ...
        public bool MarkAsSpam(DateTime at, IUser byUser, string fromIpAddress)
        {
            ...
            if (CanMarkAsSpam(byUser))
            {
                ...
                StoryMarkAsSpam.Add((StoryMarkAsSpam)spamStory);
        ...
        public bool UnmarkAsSpam(DateTime at, IUser byUser)
        {
            ...
            if (CanUnmarkAsSpam(byUser))
            {
                ...
                StoryMarkAsSpam.Remove((StoryMarkAsSpam)spam);
        ...
        public IComment PostComment(string content, DateTime at, IUser byUser, string fromIpAddress)
        {
            ...
            StoryComment.Add((StoryComment)comment);
        ...
        public bool ContainsCommentSubscriber(IUser theUser)
        {
            ...
            return User1.Any(u => u.UserName == userName) || (srcQuery != null && srcQuery.Any(u => u.UserName == userName));
        }
