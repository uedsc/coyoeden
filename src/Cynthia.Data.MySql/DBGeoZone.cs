...
namespace Cynthia.Data
{
    public static class DBGeoZone
    {
            ...
            string code)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_GeoZone (");
            ...
            string code)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_GeoZone ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_GeoZone ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetOne(Guid guid)
        {
            ...
            sqlCommand.Append("FROM	cy_GeoZone ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
            ...
            out int totalPages)
        {
            ...
            sqlCommand.Append("FROM	cy_GeoZone gz ");
            sqlCommand.Append("JOIN cy_GeoCountry gc ");
