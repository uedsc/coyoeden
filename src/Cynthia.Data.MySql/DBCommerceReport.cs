...
namespace Cynthia.Data
{
    ...
    public static class DBCommerceReport
    {
            ...
            DateTime rowCreatedUtc)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_CommerceReport (");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_CommerceReport ");
        ...
        public static IDataReader GetSalesByYearMonthBySite(Guid siteGuid)
        {
            ...
            sqlCommand.Append("cy_CommerceReport ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SiteGuid = ?SiteGuid ");
        ...
        public static IDataReader GetSalesGroupedByModule(Guid siteGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_CommerceReport ");
        ...
        public static IDataReader GetSalesGroupedByUser(Guid siteGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_CommerceReport c ");
        ...
        public static int GetDistinctItemCountByModule(Guid moduleGuid)
        {
            ...
            sqlCommand.Append("FROM	 ");
            sqlCommand.Append(" (SELECT DISTINCT ItemGuid FROM cy_CommerceReport WHERE ModuleGuid = ?ModuleGuid) AS s ");
            sqlCommand.Append(";");
        ...
        public static int GetDistinctUserItemCount(Guid siteGuid)
        {
            ...
            sqlCommand.Append("SELECT  Count(*) ");
            sqlCommand.Append("FROM	 ");
            sqlCommand.Append("(SELECT DISTINCT UserGuid FROM cy_CommerceReport ");
            sqlCommand.Append("WHERE ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_CommerceReportOrders (");
            sqlCommand.Append("RowGuid, ");
            sqlCommand.Append("SiteGuid, ");
            sqlCommand.Append("FeatureGuid, ");
            sqlCommand.Append("ModuleGuid, ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_CommerceReportOrders ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("RowGuid = ?RowGuid ");
            sqlCommand.Append(";");
