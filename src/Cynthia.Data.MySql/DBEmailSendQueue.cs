...
namespace Cynthia.Data
{
    public static class DBEmailSendQueue
    {
            ...
            DateTime createdUtc)
        {
            ...
            arParams[12] = new MySqlParameter("?TextBody", MySqlDbType.Text);
            arParams[12].Direction = ParameterDirection.Input;
            arParams[12].Value = textBody;

            arParams[13] = new MySqlParameter("?HtmlBody", MySqlDbType.Text);
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_EmailSendQueue ");
