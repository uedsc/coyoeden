...
namespace Cynthia.Data
{
    public static class DBPlugNPayLog
    {
            ...
            decimal freight)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_PlugNPayLog (");
            ...
            decimal freight)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_PlugNPayLog ");
            ...
            arParams[6] = new MySqlParameter("?ResponseCode", MySqlDbType.VarChar, 10);
            arParams[6].Direction = ParameterDirection.Input;
            ...
            arParams[10] = new MySqlParameter("?CcvCode", MySqlDbType.VarChar, 10);
            arParams[10].Direction = ParameterDirection.Input;
            arParams[10].Value = ccvCode;

            arParams[11] = new MySqlParameter("?CavCode", MySqlDbType.VarChar, 10);
            arParams[11].Direction = ParameterDirection.Input;
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_PlugNPayLog ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("RowGuid = ?RowGuid ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetOne(Guid rowGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_PlugNPayLog ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("RowGuid = ?RowGuid ");
            sqlCommand.Append(";");
