...
namespace Cynthia.Data
{
    public static class DBCurrency
    {
            ...
            DateTime lastModified)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_Currency ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_Currency ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetOne(Guid guid)
        {
            ...
            sqlCommand.Append("FROM	cy_Currency ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
        ...
        ///// <summary>
        ///// Gets a count of rows in the cy_Currency table.
        ///// </summary>
        ...
        ///// <summary>
        ///// Gets a page of data from the cy_Currency table.
        ///// </summary>
