...
namespace Cynthia.Data
{
    public static class DBModule
    {
            ...
            bool hideFromUnauthenticated)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_Modules (");
            ...
            if ((newID > -1) && (pageId > -1))
            {
                ...
                sqlCommand.Append("INSERT INTO cy_PageModules (");
                ...
                sqlCommand.Append("(SELECT PageGuid FROM cy_Pages WHERE PageID = ?PageID LIMIT 1), ");
                sqlCommand.Append("(SELECT Guid FROM cy_Modules WHERE ModuleID = ?ModuleID LIMIT 1), ");
            ...
            bool hideFromUnauthenticated)
        {
            ...
            sqlCommand.Append("UPDATE cy_Modules ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_PageModules ");
        ...
        public static bool DeleteModule(int moduleId)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_Modules ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ModuleID = ?ModuleID ;");
        ...
        public static bool PageModuleExists(int moduleId, int pageId)
        {
            ...
            sqlCommand.Append("FROM	cy_PageModules ");
            sqlCommand.Append("WHERE ModuleID = ?ModuleID AND PageID = ?PageID ; ");
        ...
        public static IDataReader PageModuleGetReaderByModule(int moduleId)
        {
            ...
            sqlCommand.Append("FROM	cy_PageModules pm ");

            sqlCommand.Append("JOIN ");
            sqlCommand.Append("cy_Modules m ");
            sqlCommand.Append("ON ");
            sqlCommand.Append("pm.ModuleID = m.ModuleID ");

            sqlCommand.Append("JOIN ");
            sqlCommand.Append("cy_Pages p ");
            sqlCommand.Append("ON ");
        ...
        public static bool UpdatePage(int oldPageId, int newPageId, int moduleId)
        {
            ...
            sqlCommand.Append("PageGuid = (SELECT PageGuid FROM cy_Pages WHERE PageID = ?NewPageID LIMIT 1) ");
            ...
            out int totalPages)
        {
            ...
            sqlCommand.Append("(SELECT COUNT(pm.PageID) FROM cy_PageModules pm WHERE pm.ModuleID = m.ModuleID) AS UseCount  ");
        ...
        public static IDataReader GetModule(int moduleId)
        {
            ...
            sqlCommand.Append("FROM	cy_Modules ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ModuleID = ?ModuleID ;");
        ...
        public static IDataReader GetModule(Guid moduleGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_Modules ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?ModuleGuid ;");
        ...
        public static IDataReader GetPageModules(int pageId)
        {
            ...
            //sqlCommand.Append("m.CacheTime,   ");
            //sqlCommand.Append("m.ShowTitle,  ");
            //sqlCommand.Append("m.EditUserID,   ");
            //sqlCommand.Append("m.AvailableForMyPage,   ");
            //sqlCommand.Append("m.HideFromAuth, ");
            //sqlCommand.Append("m.HideFromUnAuth, ");
            //sqlCommand.Append("m.CreatedByUserID,   ");
            //sqlCommand.Append("m.CreatedDate,   ");
            sqlCommand.Append("pm.PageID,   ");
            sqlCommand.Append("pm.ModuleOrder,   ");
            sqlCommand.Append("pm.PaneName,   ");
            sqlCommand.Append("pm.PublishBeginDate,   ");
...
//        FROM cy_Modules m
//          JOIN cy_PageModules mp ON m.ModuleID=mp.ModuleID
//            JOIN cy_pages p ON mp.PageID=p.PageID
//          JOIN cy_ModuleDefinitions md ON m.ModuleDefID=md.ModuleDefID
