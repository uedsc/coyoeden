...
namespace Cynthia.Data
{
    ...
    public static class DBUserLocation
    {
            ...
            DateTime lastCaptureUTC)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_UserLocation (");
            ...
            DateTime lastCaptureUTC)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_UserLocation ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_UserLocation ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("RowID = ?RowID ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetOne(Guid rowID)
        {
            ...
            sqlCommand.Append("FROM	cy_UserLocation ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("RowID = ?RowID ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetUsersByIPAddress(Guid siteGuid, string ipv4Address)
        {
            ...
            sqlCommand.Append("FROM	cy_UserLocation ul ");
        ...
        /// <summary>
        /// Gets a count of rows in the cy_UserLocation table.
        /// </summary>
        /// <param name="userGuid"> userGuid </param>
