...
namespace Cynthia.Data
{
    ...
    public static class DBLetterSendLog
    {
            ...
            string errorMessage)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_LetterSendLog ");
        ...
        public static bool DeleteByLetterInfo(Guid letterInfoGuid)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_LetterSendLog ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("LetterGuid IN (SELECT LetterGuid FROM cy_Letter WHERE LetterInfoGuid = ?LetterInfoGuid) ;");
        ...
        public static bool DeleteBySite(Guid siteGuid)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_LetterSendLog ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("LetterGuid IN (SELECT LetterGuid FROM cy_Letter WHERE ");
            sqlCommand.Append("LetterInfoGuid IN (SELECT LetterInfoGuid FROM cy_LetterInfo WHERE SiteGuid = ?SiteGuid)) ;");
