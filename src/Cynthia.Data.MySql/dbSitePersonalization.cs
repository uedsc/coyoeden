...
namespace Cynthia.Data
{
    public static class DBSitePersonalization
    {
            ...
            Guid pathId)
        {
            ...
            sqlCommand.Append("FROM	cy_SitePersonalizationPerUser ");
            ...
            DateTime lastUpdateTime)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_SitePersonalizationPerUser (ID, UserID, PathID, PageSettings, LastUpdate)");
            ...
            DateTime lastUpdateTime)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_SitePersonalizationAllUsers (PathID, PageSettings, LastUpdate)");
            sqlCommand.Append("VALUES (");
            sqlCommand.Append(" ?PathID , ");
            sqlCommand.Append(" ?PageSettings , ");
            sqlCommand.Append(" ?LastUpdate  ");
            ...
            DateTime lastUpdateTime)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_SitePersonalizationPerUser ");
            ...
            DateTime lastUpdateTime)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_SitePersonalizationAllUsers ");
            sqlCommand.Append("SET ");
            sqlCommand.Append("PageSettings = ?PageSettings, ");
            sqlCommand.Append("LastUpdate = ?LastUpdate ");
        ...
        public static Guid CreatePath(int siteId, String path)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_SitePaths (PathID, SiteID, SiteGuid, Path, LoweredPath)");
            sqlCommand.Append("VALUES (");
            sqlCommand.Append(" ?PathID , ");
