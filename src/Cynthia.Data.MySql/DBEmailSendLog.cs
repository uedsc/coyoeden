...
namespace Cynthia.Data
{
    public static class DBEmailSendLog
    {
            ...
            Guid userGuid)
        {
            ...
            arParams[9] = new MySqlParameter("?TextBody", MySqlDbType.Text);
            arParams[9].Direction = ParameterDirection.Input;
            arParams[9].Value = textBody;

            arParams[10] = new MySqlParameter("?HtmlBody", MySqlDbType.Text);
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_EmailSendLog ");
