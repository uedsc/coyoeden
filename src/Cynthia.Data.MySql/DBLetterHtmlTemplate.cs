...
namespace Cynthia.Data
{
    public static class DBLetterHtmlTemplate
    {
            ...
            DateTime lastModUTC)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_LetterHtmlTemplate (");
            ...
            arParams[3] = new MySqlParameter("?Html", MySqlDbType.Blob);
            ...
            DateTime lastModUTC)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_LetterHtmlTemplate ");
            ...
            arParams[2] = new MySqlParameter("?Html", MySqlDbType.Blob);
            arParams[2].Direction = ParameterDirection.Input;
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_LetterHtmlTemplate ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ;");
