...
namespace Cynthia.Data
{
    public static class DBSiteSettingsEx
    {
        ...
        public static IDataReader GetSiteSettingsExList(int siteId)
        {
            ...
            sqlCommand.Append("FROM	cy_SiteSettingsEx e ");

            sqlCommand.Append("JOIN ");
            sqlCommand.Append("cy_SiteSettingsExDef d ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_SiteSettingsEx");
            sqlCommand.Append("( ");
            ...
            sqlCommand.Append("cy_SiteSettingsEx e ");
            sqlCommand.Append("ON ");
            ...
            string keyValue)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_SiteSettingsEx ");
            ...
            string keyName)
        {
            ...
            sqlCommand.Append("FROM	cy_SiteSettingsEx ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SiteID = ?SiteID AND ");
            sqlCommand.Append("KeyName = ?KeyName ");
            sqlCommand.Append(";");
