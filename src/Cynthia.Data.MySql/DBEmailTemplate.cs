...
namespace Cynthia.Data
{
    public static class DBEmailTemplate
    {
            ...
            Guid lastModBy)
        {
            ...
            arParams[8] = new MySqlParameter("?TextBody", MySqlDbType.Text);
            arParams[8].Direction = ParameterDirection.Input;
            arParams[8].Value = textBody;

            arParams[9] = new MySqlParameter("?HtmlBody", MySqlDbType.Text);
            ...
            Guid lastModBy)
        {
            ...
            arParams[3] = new MySqlParameter("?TextBody", MySqlDbType.Text);
            arParams[3].Direction = ParameterDirection.Input;
            arParams[3].Value = textBody;

            arParams[4] = new MySqlParameter("?HtmlBody", MySqlDbType.Text);
            arParams[4].Direction = ParameterDirection.Input;
