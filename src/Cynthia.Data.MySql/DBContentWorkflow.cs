...
namespace Cynthia.Data
{
    public static class DBContentWorkflow
    {
            ...
            string status)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_ContentWorkflow (");
            ...
            arParams[8] = new MySqlParameter("?ContentText", MySqlDbType.Text);
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_ContentWorkflow ");
            ...
            arParams[4] = new MySqlParameter("?ContentText", MySqlDbType.Text);
            arParams[4].Direction = ParameterDirection.Input;
        ...
        public static bool DeleteByModule(Guid moduleGuid)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_ContentWorkflowAuditHistory ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ModuleGuid = ?ModuleGuid ");
            sqlCommand.Append(";");

            sqlCommand.Append("DELETE FROM cy_ContentWorkflow ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ModuleGuid = ?ModuleGuid ");
            sqlCommand.Append(";");
        ...
        public static bool DeleteBySite(Guid siteGuid)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_ContentWorkflowAuditHistory ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("ContentWorkflowGuid IN (SELECT Guid FROM cy_ContentWorkflow WHERE SiteGuid = ?SiteGuid)  ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetWorkInProgress(Guid moduleGuid)
        {
            ...
            sqlCommand.Append("FROM	cy_ContentWorkflow cw ");
            ...
            sqlCommand.Append("cy_Users createdBy ");
            sqlCommand.Append("ON ");
            sqlCommand.Append("createdBy.UserGuid = cw.UserGuid ");

            sqlCommand.Append("LEFT OUTER JOIN ");
            sqlCommand.Append("cy_ContentWorkflowAuditHistory cwah ");
            sqlCommand.Append("ON ");
            ...
            sqlCommand.Append("LEFT OUTER JOIN ");
            sqlCommand.Append("cy_Users recentActionBy ");
            sqlCommand.Append("ON ");
        ...
        public static int GetCount(Guid siteGuid, string status)
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("SELECT  Count(*) ");
            sqlCommand.Append("FROM	cy_ContentWorkflow ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("SiteGuid = ?SiteGuid ");
            sqlCommand.Append("AND ");
            sqlCommand.Append("Status = ?Status ");
            ...
            bool active)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_ContentWorkflowAuditHistory (");
            sqlCommand.Append("Guid, ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_ContentWorkflowAuditHistory ");
            sqlCommand.Append("SET  ");
