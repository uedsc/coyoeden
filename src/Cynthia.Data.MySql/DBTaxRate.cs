...
namespace Cynthia.Data
{
    public static class DBTaxRate
    {
        ...
        /// <summary>
        /// Deletes a row from the cy_TaxRate table. Returns true if row deleted.
        /// </summary>
        /// <param name="guid"> guid </param>
        /// <returns>bool</returns>
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_TaxRate ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
        ...
        /// <summary>
        /// Gets an IDataReader with one row from the cy_TaxRate table.
        /// </summary>
        /// <param name="guid"> guid </param>
        public static IDataReader GetOne(Guid guid)
        {
            ...
            sqlCommand.Append("FROM	cy_TaxRate ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
            ...
            DateTime logTime)
        {
            ...
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("INSERT INTO cy_TaxRateHistory (");
            sqlCommand.Append("Guid, ");
        ...
        ///// <summary>
        ///// Gets a count of rows in the cy_TaxRate table.
        ///// </summary>
        ...
        ///// <summary>
        ///// Gets a page of data from the cy_TaxRate table.
        ///// </summary>
