...
namespace Cynthia.Data
{
    ...
    public static class DBContentTemplate
    {
            ...
            DateTime createdUtc)
        {
            ...
            sqlCommand.Append("INSERT INTO cy_ContentTemplate (");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("UPDATE cy_ContentTemplate ");
        ...
        {
            StringBuilder sqlCommand = new StringBuilder();
            sqlCommand.Append("DELETE FROM cy_ContentTemplate ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
        ...
        public static IDataReader GetOne(Guid guid)
        {
            ...
            sqlCommand.Append("FROM	cy_ContentTemplate ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("Guid = ?Guid ");
            sqlCommand.Append(";");
