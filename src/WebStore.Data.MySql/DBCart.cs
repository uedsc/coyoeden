...
{   
    ...
    public static class DBCart
    {
            ...
            out int totalPages)
        {
            ...
            sqlCommand.Append("(SELECT COALESCE(ul.UserGuid, '00000000-0000-0000-0000-000000000000') FROM cy_UserLocation ul WHERE ul.IPAddress = c.CreatedFromIP LIMIT 1 ) AS IPUserGuid ");
           ...
           // sqlCommand.Append("ON  ");
            ...
            sqlCommand.Append("LEFT OUTER JOIN cy_Users u3  ");
            sqlCommand.Append("ON  ");
            sqlCommand.Append("u3.UserGuid = c2.UserGuid  ");

            sqlCommand.Append("LEFT OUTER JOIN cy_Users u2  ");
            sqlCommand.Append("ON  ");
            ...
            //sqlCommand.Append("(SELECT ul.UserGuid FROM cy_UserLocation ul WHERE ul.IPAddress = c.CreatedFromIP LIMIT 1 ) ");
