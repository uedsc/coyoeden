...
namespace WebStore.Data
{
    public static class DBOrder
    {
        ...
        public static void EnsureSalesReportData(Guid moduleGuid, int pageId, int moduleId)
        {
            ...
            sqlCommand.Append("AND o.StatusGuid <> 'de3b9331-b98f-493f-be5e-926ffe5003bc' ");
            sqlCommand.Append("AND o.StatusGuid <> '00000000-0000-0000-0000-000000000000' ");
            ...
            sqlCommand.Append("cy_CommerceReport cr ");
        ...
        public static void EnsureSalesReportOrderData(Guid moduleGuid, int pageId, int moduleId)
        {
            ...
            sqlCommand.Append("LEFT OUTER JOIN ");
            sqlCommand.Append("cy_CommerceReportOrders cr ");
