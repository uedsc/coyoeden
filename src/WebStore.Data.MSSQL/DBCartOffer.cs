...
namespace WebStore.Data
{
    ...
    public static class DBCartOffer
    {
            ...
            bool isDonation)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_Insert", 9);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_Delete", 1);
            sph.DefineSqlParameter("@ItemGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, itemGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_DeleteAnonymousByStore", 2);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_DeleteByStore", 2);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
            sph.DefineSqlParameter("@OlderThan", SqlDbType.DateTime, ParameterDirection.Input, olderThan);
        ...
        public static bool DeleteByCart(Guid cartGuid)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_DeleteByCart", 1);
            sph.DefineSqlParameter("@CartGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, cartGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_SelectOne", 1);
            sph.DefineSqlParameter("@ItemGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, itemGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_CartOffers_SelectByCart", 1);
            sph.DefineSqlParameter("@CartGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, cartGuid);
            return sph.ExecuteReader();
