...
namespace WebStore.Data
{
    ...
    public static class DBOrder
    {
        ...
        public static int Create(
            ...
            Guid clerkGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_Insert", 62);
            ...
            sph.DefineSqlParameter("@GatewayRawResponse", SqlDbType.NText, ParameterDirection.Input, gatewayRawResponse);
        ...
        public static bool Update(
            ...
            Guid clerkGuid)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_Update", 59);
            sph.DefineSqlParameter("@OrderGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, orderGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_Delete", 1);
            sph.DefineSqlParameter("@OrderGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, orderGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        /// <summary>
        /// Updates the cy_CommerceReport table with any missing orders
        /// </summary>
        /// <param name="orderGuid"> orderGuid </param>
        /// <returns>bool</returns>
        public static void EnsureSalesReportData(Guid moduleGuid, int pageId, int moduleId)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_EnsureReportData", 2);
        ...
        public static void EnsureSalesReportOrderData(Guid moduleGuid, int pageId, int moduleId)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_EnsureReportOrderData", 2);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
            sph.ExecuteNonQuery();
        ...
        public static void EnsureSalesReportData(Guid orderGuid, Guid moduleGuid, int pageId, int moduleId)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_EnsureReportDataForOrder", 3);
            sph.DefineSqlParameter("@OrderGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, orderGuid);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
            sph.ExecuteNonQuery();
        ...
        public static void EnsureSalesReportDataForOrders(Guid orderGuid, Guid moduleGuid, int pageId, int moduleId)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_EnsureReportOrderDataForOrder", 3);
            sph.DefineSqlParameter("@OrderGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, orderGuid);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
            sph.ExecuteNonQuery();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_TrackAnalytics", 1);
            sph.DefineSqlParameter("@OrderGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, orderGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_SelectOne", 1);
            sph.DefineSqlParameter("@OrderGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, orderGuid);
            ...
            Guid userGuid)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_SelectByUser", 2);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
            sph.DefineSqlParameter("@UserGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, userGuid);
            return sph.ExecuteReader();
		...
		{
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_GetCount", 1);
			sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
        ...
        public static IDataReader GetByStore(
            ...
            int pageSize)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_SelectPage", 3);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_GetSalesByYearMonth", 1);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_GetRevenueSummary", 1);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetConnectionString(), "ws_Order_GetAllTimeRevenue", 1);
            sph.DefineSqlParameter("@StoreGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, storeGuid);
