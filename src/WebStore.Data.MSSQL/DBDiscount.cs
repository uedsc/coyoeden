...
namespace WebStore.Data
{
    ...
    public static class DBDiscount
    {
        ...
        public static int Create(
            ...
            DateTime createdUtc)
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "ws_Discount_Insert", 19);
            ...
            DateTime lastModUtc)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "ws_Discount_Update", 14);
            sph.DefineSqlParameter("@DiscountGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, discountGuid);
            sph.DefineSqlParameter("@DiscountCode", SqlDbType.NVarChar, 255, ParameterDirection.Input, discountCode);
            sph.DefineSqlParameter("@Description", SqlDbType.NVarChar, 255, ParameterDirection.Input, description);
            sph.DefineSqlParameter("@OfferGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, offerGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "ws_Discount_Delete", 1);
            sph.DefineSqlParameter("@DiscountGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, discountGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "ws_Discount_DeleteBySite", 1);
            sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "ws_Discount_DeleteByModule", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetWriteConnectionString(), "ws_Discount_DeleteByOffer", 1);
            sph.DefineSqlParameter("@OfferGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, offerGuid);
            int rowsAffected = sph.ExecuteNonQuery();
            return (rowsAffected > 0);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "ws_Discount_SelectOne", 1);
            sph.DefineSqlParameter("@DiscountGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, discountGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "ws_Discount_SelectByDiscountCode", 2);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            sph.DefineSqlParameter("@DiscountCode", SqlDbType.NVarChar, 255, ParameterDirection.Input, discountCode);
            return sph.ExecuteReader();
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "ws_Discount_Find", 2);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "ws_Discount_GetCount", 1);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
        ...
        {
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "ws_Discount_GetCountOfActive", 2);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
            ...
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(GetReadConnectionString(), "ws_Discount_SelectPage", 3);
            sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
